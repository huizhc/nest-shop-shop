...
export function processParams(type, params) {
  let data = Object.assign({}, params);
  if (type == "daterange") {
    return {
      ...data,
      time: Array.isArray(params.time)
...
export function addW(num) {
  if (num.toString().length > 4) {
    num = (num / 1e4).toFixed(3)
    num = num.slice(0, num.length - 1) + 'w'
  }
  return num
}

export function rectPx(v) {
  return (v / 750) *
