    ...
    <div class="top center">
      <div class="logo center">
        <a href="./index.html" target="_blank"
          ><img src="/default/image/mistore_logo.png" alt=""
        /></a>
      </div>
    </div>
    <div class="login">
      <div class="login_center">
        <div class="login_top">
          ...
          <div class="right fr">
            您还不是我们的会员？<a href="/pass/registerStep1" target="_self"
              >立即注册</a
            >
          </div>
          <div class="clear"></div>
...
export default {
  data() {
    return {
      ...
      codeImg:
        process.env.VUE_APP_BASE_API + "/base/pass/code?width=80&height=40",
    };
  },
  mounted() {
    let that = this;
      ...
      $("#doLogin").click(function (e) {
        ...
        that.$store
          ...
          .then((res) => {
            console.log(12345);
            let href = ""
            if (isExternal(href = decodeURIComponent(that.redirect))) {
              location.href = href
            } else {
  ...
  methods: {
    changeImg() {
      this.codeImg =
        ...
        "/base/pass/code?width=80&height=40&t=" +
        Date.now();
    },
  },
};
...
body,h1,h2,h3,h4,h5,h6{font: 12px 微软雅黑,Times New Roman;}
div.login_page{background: rgb(20,33,42)  }
div.register_page{background: #eee  }
/*预定义样式*/
...
.form{width: 1130px;height:588px;background: url('../../assets/image/login_bg.jpg')no-repeat center center; }
...
.login_main .username .yanzhengma{width: 100px;height: 30px;border:1px solid #ccc;padding:5px 10px; color:#000;}
...
.login .login_center .return{border:none;width: 240px;height: 45px;margin-left:55px;background: #eee;color: #fff; font-size: 20px;font-weight: bold;letter-spacing: 2px;cursor:pointer;border-radius: 4px;}
