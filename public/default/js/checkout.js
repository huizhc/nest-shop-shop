    ...
    var app={
        ...
        doEditAddress:function(){
            ...
            $("#doEditAddress").click(function(){
                ...
                $.post('/user/address/doEditAddressList',{id:id,name:name,phone:phone,address:address,zipcode:zipcode},function(response){
        ...
        addAddress:function(){
            ...
            $("#addAddress").click(function () {
				...
				$.post('/user/address/addAddress', { name: name, phone: phone, address: address, zipcode: zipcode }, function (response) {
